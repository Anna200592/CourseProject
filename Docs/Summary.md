...
Написание кода автотестов - 28 часов - было потрачено 30 часов - автоматизация тестирования заняла чуть дольше времени, 
потому что изначально время оказалось ошибочное
